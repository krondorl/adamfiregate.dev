  ...
  <main class="main center">
    <div class="left">
      <a href="/" class="head-link-to-cover">
        ...
        <path class="st0" d="M4.9,35.5c38-38,99.5-38,137.5,0c0,0,0,0,0,0l0,0c30.4,30.4,30.4,79.6,0,110c-24.3,24.3-63.7,24.3-88,0
            C35,126,35,94.5,54.4,75.1c15.5-15.5,40.8-15.5,56.3,0c12.4,12.4,12.4,32.6,0,45c-10,10-26.1,10-36,0c-8-8-8-20.9,0-28.8l0,0
      ...
      <ul>
        ...
        <li>LW Recordings</li>
        <li>Underground Revolution Recordings</li>
        <li>Be52 Records</li>
        <li>AH Digital</li>
        <li>Most Dubstep Records</li>
        <li>Happy Days Records</li>
        <li>Noize Reaction</li>
        <li>Morningglory Music</li>
        <li>Arcadia Moon</li>
        <li>Quebolarecords</li>
        <li>Sounds United</li>
        <li>Rimoshee Recordings</li>
        <li>Rimoshee Traxx</li>
        <li>Istmo Music</li>
        <li>Tokyo Women Records</li>
        <li>AWAL</li>
      </ul>
      ...
      <div class="center">
        ...
        <p><a href="/" class="submit">Download!</a></p>
      </div>
    </div>
  </main>
